...
def convert_to_left_rectangle(a):
    img_depth_list = []
    for i in range(a.shape[-1]):
        img_depth_list.append(
            [
                [
                    a[17, i],
                    (a[17, i] + a[12, i] + a[16, i]) / 3,
                    a[16, i],
                    (a[16, i] + a[11, i] + a[18, i]) / 3,
                    a[18, i],
                    (a[18, i] + a[10, i] + a[15, i]) / 3,
                    a[15, i],
                ],
                [
                    (a[17, i] + a[12, i] + a[16, i]) / 3,
                    a[12, i],
                    (a[12, i] + a[16, i] + a[11, i] + a[5, i] + a[6, i]) / 5,
                    a[11, i],
                    (a[11, i] + a[18, i] + a[10, i] + a[4, i] + a[5, i]) / 5,
                    a[10, i],
                    (a[15, i] + a[10, i] + a[9, i]) / 3,
                ],
                [
                    a[13, i],
                    (a[13, i] + a[12, i] + a[6, i] + a[7, i] + a[1, i]) / 5,
                    a[6, i],
                    a[5, i],
                    a[4, i],
                    (a[4, i] + a[10, i] + a[9, i] + a[3, i] + a[0, i]) / 5,
                    a[9, i],
                ],
                [
                    (a[13, i] + a[7, i] + a[8, i] + a[14, i]) / 4,
                    a[7, i],
                    a[1, i],
                    (
                        a[6, i]
                ...
                [
                    ...
                    a[36, i],
                    a[30, i],
                    (a[29, i] + a[23, i] + a[24, i] + a[30, i]) / 4,
                ],
                [
                    a[28, i],
                    (a[28, i] + a[37, i] + a[35, i] + a[33, i] + a[27, i]) / 5,
                    a[33, i],
                    a[32, i],
                    a[31, i],
                    (a[24, i] + a[25, i] + a[36, i] + a[31, i] + a[30, i]) / 5,
                    a[24, i],
                ],
                [
                    (a[28, i] + a[27, i] + a[22, i]) / 3,
                    a[27, i],
                    (a[27, i] + a[33, i] + a[32, i] + a[26, i] + a[21, i]) / 5,
                    a[26, i],
                    (a[26, i] + a[32, i] + a[31, i] + a[25, i] + a[20, i]) / 5,
                    a[25, i],
                    (a[24, i] + a[25, i] + a[19, i]) / 3,
                ],
                [
                    a[22, i],
                    (a[22, i] + a[27, i] + a[21, i]) / 3,
                    a[21, i],
                    (a[21, i] + a[26, i] + a[20, i]) / 3,
                    a[20, i],
                    (a[20, i] + a[25, i] + a[19, i]) / 3,
                    a[19, i],
                ],
            ]
        )
...
def convert_to_right_rectangle(a):
    img_depth_list = []
    for i in range(a.shape[-1]):
        img_depth_list.append(
            [
                [
                    a[19, i],
                    (a[19, i] + a[20, i] + a[25, i]) / 3,
                    a[20, i],
                    (a[20, i] + a[21, i] + a[26, i]) / 3,
                    a[21, i],
                    (a[21, i] + a[22, i] + a[27, i]) / 3,
                    a[22, i],
                ],
                [
                    (a[19, i] + a[25, i] + a[24, i]) / 3,
                    a[25, i],
                    (a[25, i] + a[20, i] + a[26, i] + a[32, i] + a[31, i]) / 5,
                    a[26, i],
                    (a[26, i] + a[21, i] + a[27, i] + a[33, i] + a[32, i]) / 5,
                    a[27, i],
                    (a[27, i] + a[22, i] + a[28, i]) / 3,
                ],
                [
                    a[24, i],
                    (a[24, i] + a[25, i] + a[31, i] + a[36, i] + a[30, i]) / 5,
                    a[31, i],
                    a[32, i],
                    a[33, i],
                    (a[33, i] + a[27, i] + a[28, i] + a[34, i] + a[37, i]) / 5,
                    a[28, i],
                ],
                [
                    (a[24, i] + a[30, i] + a[29, i] + a[23, i]) / 4,
                    a[30, i],
                    a[36, i],
                    (
                        a[36, i]
                ...
                [
                    ...
                    a[1, i],
                    a[7, i],
                    (a[7, i] + a[18, i] + a[13, i] + a[12, i]) / 4,
                ],
                [
                    a[8, i],
                    (a[8, i] + a[3, i] + a[0, i] + a[4, i] + a[9, i]) / 5,
                    a[4, i],
                    a[5, i],
                    a[6, i],
                    (a[6, i] + a[1, i] + a[7, i] + a[12, i] + a[11, i]) / 5,
                    a[12, i],
                ],
                [
                    (a[8, i] + a[9, i] + a[14, i]) / 3,
                    a[9, i],
                    (a[9, i] + a[4, i] + a[5, i] + a[10, i] + a[15, i]) / 5,
                    a[10, i],
                    (a[10, i] + a[5, i] + a[6, i] + a[11, i] + a[16, i]) / 5,
                    a[11, i],
                    (a[11, i] + a[17, i] + a[12, i]) / 3,
                ],
                [
                    a[14, i],
                    (a[14, i] + a[9, i] + a[15, i]) / 3,
                    a[15, i],
                    (a[15, i] + a[10, i] + a[16, i]) / 3,
                    a[16, i],
                    (a[16, i] + a[11, i] + a[17, i]) / 3,
                    a[17, i],
                ],
            ]
        )
...
for k in range(N):
    ...
    for channel in range(2):
        ...
        img_depth_right = convert_to_left_rectangle(a[:39])
        img_depth_left = convert_to_right_rectangle(a[39:])
